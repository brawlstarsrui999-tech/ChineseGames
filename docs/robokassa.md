...
| `style_anime` | Аниме-декор, пиксельные персонажи, звуки и музыка | 199 ₽ |
| `mascot` | Голосовой чиби-талисман | 499 ₽ |
...
https://auth.robokassa.ru/Merchant/Index.aspx
  ...
  &Shp_product=style_anime
  &SignatureValue=md5(<login>:199.00:<invoice>:<password1>:Shp_product=style_anime)
  &IsTest=1
```
