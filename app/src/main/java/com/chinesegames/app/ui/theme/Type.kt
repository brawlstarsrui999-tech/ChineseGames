 ...
 *
 * Пользовательский размер текста применяется глобально через LocalDensity в
 * MainActivity, поэтому он одинаково влияет на эту типографику, PixelType и
 * на все точечно заданные значения в sp.
 */
